import type { HTMLAttributes, InputHTMLAttributes, RefObject, SetStateAction } from 'react'
...
type UseSupabaseUploadReturn = {
  files: DropzoneFile[]
  setFiles: (files: SetStateAction<DropzoneFile[]>) => void
  onUpload: () => void | Promise<void>
  loading: boolean
  successes: string[]
  errors: DropzoneUploadError[]
  maxFileSize: number
  maxFiles: number
  isSuccess: boolean
  ...
  getRootProps: (options?: { className?: string }) => HTMLAttributes<HTMLDivElement>
